    ...
    <v-container fluid class="pa-0 full-height">
        ...
        <v-col cols="12" md="4" class="pa-4">
            ...
            <div class="scroll-area">
                <v-list dense>
                <v-list-item
                    v-for="(value, key) in clientCompany"
                    :key="key"
        ...
        <v-col cols="12" md="4" class="pa-4 d-flex flex-column">
            <v-card outlined class="pa-3 full-height-card" style="display: flex; flex-direction: column; width:100%; box-sizing:border-box;">
            ...
            >
                ...
                <v-row dense no-gutters>
                    ...
                    :key="key"
                    v-if="!['id','name','age','favorite'].includes(key)"
                    cols="6"
                    >
...
const customers = ref([
    { id: 1, name: '김민수', clientCompany: '디올', owner: '김민수', department: '영업', position: '팀장', email: 'kim@example.com', phone: '010-1234-5678', favorite: true },
    { id: 2, name: '박영희', clientCompany: '디올', owner: '박영희', department: '마케팅', position: '사원', email: 'park@example.com', phone: '010-9876-5432', favorite: false },
]);
...
/* ==================== 고객 리스트 영역 ==================== */
.list-area {
    max-height: 280px; /* 카드 4~5개 정도 */
    overflow-y: auto;
}

.customer-item-card {
    padding: 6px 8px; /* 촘촘하게 */
    border-radius: 10px;
    background-color: #ffffff;
    cursor: pointer;
    font-size: 0.85rem;
