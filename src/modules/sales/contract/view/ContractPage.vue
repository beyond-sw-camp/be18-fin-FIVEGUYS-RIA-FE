        ...
        <v-col cols="12" md="10" class="pa-6 main-content">
            ...
            >
                ...
                <v-card-text class="pa-0 d-flex justify-space-between align-center">
                    ...
                    <span>계약일: {{ proposal.contractDate }}</span>
                    <span>총 금액: {{ formatPrice(proposal.totalPrice) }}</span>
                    </span>
                </v-card-text>
...
const proposals = reactive([
    { id: 1, projectName: '계약 A', clientCompany: '삼성전자', clientOwner: '김영업', salesManager: '박팀장',
        estimateDate: '2025-11-01', estimatePrice: 1500000, sidebar: 'Draft', isFavorite: false,
        contractDate: '2025-11-15', totalPrice: 1800000 },

    { id: 2, projectName: '계약 B', clientCompany: 'LG CNS', clientOwner: '이영희', salesManager: '최팀장',
        estimateDate: '2025-12-02', estimatePrice: 2800000, sidebar: 'Submitted', isFavorite: true,
        contractDate: '2025-12-10', totalPrice: 3000000 },

    { id: 3, projectName: '계약 C', clientCompany: '카카오', clientOwner: '홍길동', salesManager: '이팀장',
        estimateDate: '2025-12-10', estimatePrice: 5200000, sidebar: 'Completed', isFavorite: false,
        contractDate: '2025-12-20', totalPrice: 5500000 },
]);
